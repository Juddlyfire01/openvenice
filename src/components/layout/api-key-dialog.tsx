...
export function ApiKeyDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby={titleId}>
      ...
      <div
        className="relative bg-[var(--color-bg-overlay)] border border-[var(--color-border-soft)] rounded-xl p-6 w-full max-w-sm mx-4 animate-scale-in shadow-2xl shadow-black/60"
        ...
        {isUnlockMode ? (
          <div>
            ...
            <input
              ...
              className="w-full bg-[var(--color-bg-input)] border border-[var(--color-border-soft)] rounded-lg px-3.5 py-2.5 text-[16px] text-white outline-none focus:border-white/[0.25] transition-colors placeholder:text-white/25"
              autoFocus
          ...
          <>
            ...
            <input
              ...
              placeholder="sk-..."
              className="w-full bg-[var(--color-bg-input)] border border-[var(--color-border-soft)] rounded-lg px-3.5 py-2.5 text-[16px] text-white outline-none focus:border-white/[0.25] transition-colors font-mono placeholder:text-white/25"
              autoFocus
              autoComplete="off"
